...
const plans = [
  {
    ...
    features: [
      "Monthly returns: 1% on invested capital",
      "Total returns: 12% on invested capital",
  ...
  },
  {
    ...
    features: [
      "Monthly returns: 1.25% on invested capital",
      "Total returns: 15% on invested capital",
      "Monthly interest payouts (Optional)",
  ...
  },
  {
    ...
    features: [
      "Monthly returns: 1.5% on invested capital",
      "Total returns: 18% on invested capital",
      "Monthly interest payouts (Optional)",
  ...
  },
  {
    ...
    features: [
       "Monthly returns: 1.75% on invested capital",
      "Total returns: 21% on invested capital",
      "Monthly interest payouts (Optional)",
      "Minimum investment: ₹1 L",
      "Email support",
    ],
    popular: false,
  },
